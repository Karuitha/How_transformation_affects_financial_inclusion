...
tribble(~ Variables, ~ Percent_female, ~ Percent_female, ~ Percent_female, ~ Average_loan, ~ Average_loan, ~ Average_loan, ~ Gross_loans, ~ Gross_loans, ~ Gross_loans, "", "Full data", ">=3 years", ">= 5 years", "Full data", ">=3 years", ">= 5 years", "Full data", ">=3 years", ">= 5 years", "", "(1)", "(2)", "(3)", "(4)", "(5)", "(6)", "(7)", "(8)", "(9)", "Credit Union", "0.099", "0.099", "0.098", "1654.000", "1657.000", "1768.000", "0.052", "0.052", "0.065", "", "(0.124)", "(0.124)", "(0.127)", "(1520.000)", "(1568.000)", "(1856.000)", "(0.248)", "(0.252)", "(0.254)", "Age: Young", "-0.009", "-0.009", "-0.010", "-1,138.000***", "-1,143.000***", "-1,238.000***", "0.117***", "0.118***", "0.131***", "", "(0.013)", "(0.013)", "(0.014)", "(347.000)", "(350.000)", "(387.000)", "(0.031)", "(0.031)", "(0.034)", "Age: Mature", "-0.005", "-0.005", "-0.005", "-1,533.000**", "-1,537.000**", "-1,657.000**", "0.163***", "0.164***", "0.176***", "", "(0.018)", "(0.018)", "(0.019)", "(600.000)", "(607.000)", "(648.000)", "(0.040)", "(0.040)", "(0.044)", "Op exp/assets", "0.067*", "0.067*", "0.072*", "1,775.000", "1,787.000", "2,205.000", "0.279***", "0.280***", "0.306***", "", "(0.036)", "(0.036)", "(0.037)", "(1,844.000)", "(1,872.000)", "(1,978.000)", "(0.090)", "(0.091)", "(0.097)", "Donations/assets", "-0.012", "-0.012", "-0.016", "1663.000", "1662.000", "1478.000", "-0.315***", "-0.316***", "-0.324***", "", "(0.031)", "(0.032)", "(0.034)", "(1,227.000)", "(1,237.000)", "(1,338.000)", "(0.100)", "(0.101)", "(0.105)", "Capital to assets", "-0.004", "-0.004", "-0.007", "797.000***", "797.000***", "1,049.000***", "1.100***", "1.100***", "1.260***", "", "(0.007)", "(0.007)", "(0.010)", "(244.000)", "(247.000)", "(339.000)", "(0.034)", "(0.035)", "(0.047)", "Asset structure", "0.081", "0.083", "0.076", "478.000", "558.000", "-1,137.000", "-0.730***", "-0.722***", "-1.050***", "", "(0.081)", "(0.081)", "(0.088)", "(3,930.000)", "(4,074.000)", "(4,311.000)", "(0.218)", "(0.226)", "(0.250)", "Size (Lassets)", "0.011", "0.011", "0.012", "7,398.000***", "7,412.000***", "7,832.000***", "-0.087***", "-0.088***", "-0.047", "", "(0.014)", "(0.014)", "(0.015)", "(868.000)", "(877.000)", "(945.000)", "(0.034)", "(0.034)", "(0.037)", "Education", "0.192**", "0.193**", "0.205**", "-2,370.000", "-2,355.000", "-2,604.000", "0.008", "0.007", "-0.029", "", "(0.090)", "(0.090)", "(0.093)", "(3,472.000)", "(3,506.000)", "(3,708.000)", "(0.189)", "(0.191)", "(0.212)", "Profit Margin", "0.02", "0.02", "0.03", "-159.000***", "-160.000***", "-160.000***", "0.015***", "0.016***", "0.014***", "", "(0.002)", "(0.002)", "(0.002)", "(39.500)", "(40.000)", "(39.900)", "(0.004)", "(0.004)", "(0.004)", "r.squared", "4.26e-02", "4.27e-02", "4.47e-02", "7.52e-02", "7.54e-02", "7.97e-02", "0.517", "0.518", " 0.527", "adj.r.squared", "-8.83e-02", "-8.33e-02", "-6.31e-02", "-5.68e-02", "-5.03e-02", "-2.61e-02", "0.444", "0.451", "0.473", "statistic", "4.23***", "4.21***",  "4.13***",  "8.02***", "7.98***",  "7.84***",  "108.395***",  "106.966***", "101.779***", "nobs", "3240", "3210",  "2950",  "3380",  "3340",  "3030", "3497", "3405", "3056") %>% 
  ...
  footnote(general = "Authors' construction from the MIX data",
           ...
           number = c("Fixed Effects Regressions- Standard errors in brackets(***1%, **5%, *10%)`"),
...
kbl(., caption = "Random Effects and Pooled OLS Regressions (Standard Errors in brackets)", 
  ...
  footnote(general = "Authors' construction from the MIX data",
           ...
           number = c("Random Effects and Pooled OLS Regressions- Standard errors in brackets(***1%, **5%, *10%)`"),
...
kbl(., caption = "Fixed Effects, Random Effects and Pooled OLS Regressions Using Winsorized Data (Standard Errors in brackets)", 
  ...
  footnote(general = "Authors' construction from the MIX data",
           ...
           number = c("Fixed Effects, Random Effects and Pooled OLS Regressions Using Winsorozed Data- Standard errors in brackets(***1%, **5%, *10%)`"),
...
```{r, fig.cap = "Correlation Between Gross Loans to Assets, Average Loan Balance per Borrower, and Percent of Female Borrowers"}
...
```{r, fig.cap = "Normal QQ Plots for the Regression Models"}
...
```{r, fig.cap = "Normal QQ Plots for Regressions Using Winsorized Data"}
...
```{r, fig.cap = "Trends in Debt/Equity Ratio"}
## Size - Log of assets
(de <- data %>% 
...
```{r, fig.cap = "Debt to Equity Ratio by MFI Legal Status"}
...
```{r, fig.cap = "Donations to Assets Ratio by MFI Legal Status"}
second_plotter(data = data, x = currentlegalstatus, 
        z = currentlegalstatus,
...
```{r, fig.cap = "Trends in the Percent of Female Borrowers by Legal Tradition"}
## Percent of female borrowers - trends over time
data %>% 
...
```{r, fig.cap = "rends in Average Loan Balance per Borrower by MFI Legal Status"}
## Average loan Balance per borrower
data %>% 
...
```{r, fig.cap = "Trends in Gross Loans to Assets Ratio by MFI Legal Status"}
## Gross loan portfolio to assets 
data %>% 

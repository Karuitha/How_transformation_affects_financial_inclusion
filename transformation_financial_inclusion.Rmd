...
```{r, fig.cap = "Donations to Assets Ratio by MFI Legal Status", fig.height=5, fig.width=8}
second_plotter(data = data, x = currentlegalstatus, 
        z = currentlegalstatus,
...
```{r, fig.cap = "Trends in Average Loan Balance per Borrower by MFI Legal Status", fig.height=5, fig.width=8}
## Average loan Balance per borrower
data %>% 
...
```{r, fig.cap = "Trends in Gross Loans to Assets Ratio by MFI Legal Status", fig.height=5, fig.width=8}
## Gross loan portfolio to assets 
data %>% 

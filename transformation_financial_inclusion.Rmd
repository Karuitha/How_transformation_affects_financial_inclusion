...
box1 <- second_plotter(data = my_data, x = currentlegalstatus, 
...
```{r, fig.cap = "Donations, Capital to Assets, Age"}
...
```{r}
my_data %>% select(currentlegalstatus, age) %>% skim() %>% 
...
```{r}
my_data %>% group_by(currentlegalstatus) %>% 
